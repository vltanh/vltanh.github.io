...
Hàm $\sigma$ được gọi là **hàm softmax**. Có thể thấy, ở đây, nó ánh xạ từ $\mathbb{R}^C$ đến $[0, 1]^C$.
...
Nếu mà bạn học đại số tuyến tính và giáo viên của bạn cũng nice như Gilbert Strang (hoặc bạn tự đọc gì đấy) thì chắc là các bạn đã biết phép nhân ma trận $EF$ sẽ tạo ra ma trận $G$ sao cho dòng thứ $c$ của nó là tổ hợp tuyến tính của các dòng của $F$ với hệ số là các phần tử của dòng thứ $c$ của $E$.
