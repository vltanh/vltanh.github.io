...
- DL: Đỏ nhắm bắn Lam. Tương tự, 0.8 khả năng Đỏ thắng và 0.2 khả năng thứ tự trở thành LD. Lúc này, Lam sẽ nhắm Đỏ, với 0.5 khả năng Lam thắng và 0.5 khả năng thứ tự quay lại DL.
  - $P(V \mid DL) = 0$;
  - $P(D \mid DL) = 0.8 \times 1 + 0.2  P(D \mid LD) = 0.8 + 0.2 [0.5 \times 0 + 0.5  P(D \mid DL)] \Rightarrow P(D \mid DL) = 8/9$;
  - $P(L \mid DL) = 0.8 \times 0 + 0.2  P(L \mid LD) = 0.2 [0.5 \times 1 + 0.5  P(L \mid DL)] \Rightarrow P(L \mid DL) = 1/9$.
...
- VDL:
  ...
  - Như vậy \mid chiến thuật tốt nhất của Vàng là bắn Đỏ, khi đó:
...
- $P(V thắng) = 0.5 \times 1/2 + 0.5 \times 1/10 = 0.3$;
- $P(D thắng) = 0.5 \times 0 + 0.5 \times 16/45 = 8/45 ~ 0.1778$;
- $P(L thắng) = 0.5 \times 1/2 + 0.5 \times 49/90 = 27/90 ~ 0.5222$.
